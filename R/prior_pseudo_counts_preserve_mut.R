...
#'
#' The function \code{add_counts} adds pseudo counts to the number of mutations to incorporate prior information and avoid counts of zero while preserving the total number of mutations per sample.
#'
...
#'
#' Note that the number of mutations per sample is preserved (except when it is zero, then it is set to 1).
#'
#'
...
#'
#' @seealso \code{\link{add_counts}} -- does the same without preserving the number of mutations per sample. 
#'
