...
# with neighbors
models[1,] = c(T, F, T, T, T, T, T, rep(F, 5)) 

# without neighbors
models[2,] = c(T, F, F, T, T, T, T, rep(F, 5)) 
...
save(models, subsets, intercept, file="Fredriksson_preselection_models_step3_expression.Rdata")
